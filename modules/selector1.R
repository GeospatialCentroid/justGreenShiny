  ...
  div(
    ...
    div(
      ...
      div(
        ...
        div(
          id = "ls_info",
          tags$span("Lives Saved:", style = "color: #555; font-weight: 500; margin-right: 5px;"),
          uiOutput(ns("ls_comp"), container = tags$span)
        ),
        div(
          id = "stroke_info",
          tags$span("Stroke Cases Prevented:", style = "color: #555; font-weight: 500; margin-right: 5px;"),
          uiOutput(ns("scp_comp"), container = tags$span)
        ),
        div(
          id = "deme_info",
          tags$span("Dementia Cases Prevented:", style = "color: #555; font-weight: 500; margin-right: 5px;"),
